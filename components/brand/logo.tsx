...
export function Logo({
  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      ...
      >
        <defs>
          <linearGradient id="bowly-coupe" x1="0" y1="1" x2="1" y2="0">
            ...
            <stop offset="100%" stopColor="var(--brand-hot)" />
          </linearGradient>
          <linearGradient id="bowly-rim" x1="1" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--plasma)" stopOpacity="0.95" />
            <stop offset="70%" stopColor="var(--plasma)" stopOpacity="0" />
          </linearGradient>
        </defs>
      ...
      {avecTexte && (
        <span className="text-bone font-poster text-2xl leading-none tracking-tight">
          BOWLY&apos;S
        </span>
      )}
    </span>
